...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs()
          ...
          .withKD(0)
          .withKS(0.14456)
          .withKV(0.67141); // kS=0, kV=0.124 < DEFAULT
  ...
  private static final Current kSlipCurrent = Amps.of(120.0); // 120
  ...
  public static final CANBus kCANBus = new CANBus("CAN", "./logs/example.hoot");

  // Theoretical free speed (m/s) at 12 V applied output;
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.41 * 3.33333333);
  ...
  private static final Distance kWheelRadius = Inches.of(1.855); // 2
